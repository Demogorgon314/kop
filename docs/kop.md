---
download: "https://github.com/streamnative/kop/releases/download/v2.10.5.8/pulsar-protocol-handler-kafka-2.10.5.8.nar"
...
1. Download KoP protocol handler, or build the `./kafka-impl/target/pulsar-protocol-handler-kafka-2.10.5.8.nar` file, and then copy it to your Pulsar `protocols` directory.
...
3. Get the `.nar` file in the following directory and copy it to your Pulsar `protocols` directory. You need to create the `protocols` folder in Pulsar if it's the first time you use protocol handlers.
    ...
    ```bash
    ./kafka-impl/target/pulsar-protocol-handler-kafka-2.10.5.8.nar
    ```
...
-   [Configure KoP](https://github.com/streamnative/kop/blob/branch-2.10.5.8/docs/configuration.md)
-   [Monitor KoP](https://github.com/streamnative/kop/blob/branch-2.10.5.8/docs/reference-metrics.md)
-   [Upgrade](https://github.com/streamnative/kop/blob/branch-2.10.5.8/docs/upgrade.md)
-   [Secure KoP](https://github.com/streamnative/kop/blob/branch-2.10.5.8/docs/security.md)
-   [Schema Registry](https://github.com/streamnative/kop/blob/branch-2.10.5.8/docs/schema.md)
-   [Implementation: How to converse Pulsar and Kafka](https://github.com/streamnative/kop/blob/branch-2.10.5.8/docs/implementation.md)
